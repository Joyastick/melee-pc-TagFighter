...
#include "version_git.h"  // generated by cmake/GenerateVersion.cmake, may define MELEE_APP_VERSION
#endif

// Fallback for builds without the generated header (e.g. version_test/updater_test).
#ifndef MELEE_APP_VERSION
#define MELEE_APP_VERSION "v0.5-beta"
#endif

// Version of the upstream 999sian/melee-pc port this fork last merged from.
#ifndef MELEE_UPSTREAM_PC_VERSION
#define MELEE_UPSTREAM_PC_VERSION "v0.2.1-beta"
#endif
