...
void pc_touch_set_pad(uint16_t buttons, int8_t stickX, int8_t stickY,
                      int8_t cstickX, int8_t cstickY,
                      uint8_t triggerL, uint8_t triggerR)
{
...
Java_dev_melee_TouchControls_nativeSetTouchPad(
    JNIEnv* env, jclass clazz,
    jint buttons,
    jint stickX, jint stickY,
    jint cstickX, jint cstickY,
    jint triggerL, jint triggerR)
{
    (void) env;
    (void) clazz;
    pc_touch_set_pad((uint16_t) buttons, (int8_t) stickX, (int8_t) stickY,
                     (int8_t) cstickX, (int8_t) cstickY,
                     (uint8_t) triggerL, (uint8_t) triggerR);
}
...
__attribute__((visibility("default")))
JNIEXPORT void JNICALL
Java_dev_melee_TouchControls_nativeSetTouchActive(
...
void pc_touch_set_pad(uint16_t buttons, int8_t stickX, int8_t stickY,
                      ...
                      uint8_t triggerL, uint8_t triggerR)
{
    (void) buttons; (void) stickX; (void) stickY;
    (void) cstickX; (void) cstickY;
    (void) triggerL; (void) triggerR;
}
