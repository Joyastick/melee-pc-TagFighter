...
typedef struct Rules {
    ...
    uint8_t layout;       /* NET_LAYOUT_*: the host's; Matchmaking only in Tag Battle */
    PcNetTeam team;       /* the host's team (used when layout is matchmade) */
...
enum { NET_LAYOUT_DIRECT, NET_LAYOUT_MATCHMADE };
